...
if ( get_theme_mod( 'services_section_enable', true ) ) {
    $background_color = get_theme_mod( 'services_section_bg_color', 'rgba(255, 255, 255, 1)' );
    $background_image = get_theme_mod( 'services_section_bg_image', '' );
    ...
    $button_text  = get_theme_mod( 'services_section_button_text', 'More Services' );
    $button_link  = get_theme_mod( 'services_section_button_link', '#' );
